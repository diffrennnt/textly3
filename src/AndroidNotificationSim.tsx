    ...
    <AnimatePresence>
      {notification && (
        <motion.div
          ...
          className="fixed top-2 left-2 right-2 z-50 max-w-md mx-auto"
        >
          <div className="bg-slate-900 text-white rounded-2xl shadow-2xl border border-slate-800 p-3.5 backdrop-blur-lg">
            ...
            <div className="flex items-center justify-between text-xs text-slate-400 mb-1.5 px-0.5">
              <div className="flex items-center gap-1.5">
                <span className="w-4 h-4 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center font-bold text-[9px]">
                  TX
                </span>
            ...
            <div
              onClick={() => {
                onOpenMessage(notification.message);
                onDismiss();
              }}
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-2.5 flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 text-[11px] font-medium text-emerald-400 bg-emerald-950/80 border border-emerald-800/50 px-2.5 py-1 rounded-lg group-hover:bg-emerald-600 group-hover:text-white transition-all">
